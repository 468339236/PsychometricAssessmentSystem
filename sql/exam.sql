...
CREATE TABLE `admin` (
                         ...
                         `adminName` VARCHAR ( 20 ) CHARACTER
                             SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '姓名',
                         `sex` VARCHAR ( 2 ) CHARACTER
                             SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '性别',
                         `tel` VARCHAR ( 11 ) CHARACTER
                             SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '电话号码',
                         `email` VARCHAR ( 20 ) CHARACTER
                             SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '电子邮箱',
                         `pwd` VARCHAR ( 16 ) CHARACTER
                             SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '密码',
                         `cardId` VARCHAR ( 18 ) CHARACTER
                             SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '身份证号',
                         `role` VARCHAR ( 1 ) CHARACTER
                             SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '角色(0管理员，1教师，2学生)',
                         PRIMARY KEY ( `adminId` ) USING BTREE,
                         INDEX `sex` ( `sex` ) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9528 CHARACTER
SET = utf8 COLLATE = utf8_bin COMMENT = '管理员信息表' ROW_FORMAT = Dynamic;-- ----------------------------
-- Records of admin
-- ----------------------------
INSERT INTO `admin`
VALUES
...
CREATE TABLE `exam_manage` (
                               ...
                               `description` VARCHAR ( 50 ) CHARACTER
                                   SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '该次考试介绍',
                               `source` VARCHAR ( 20 ) CHARACTER
                                   SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '课程名称',
                               `paperId` INT ( 10 ) NULL DEFAULT NULL COMMENT '试卷编号',
                               `examDate` VARCHAR ( 10 ) CHARACTER
                                   SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '考试日期',
                               `totalTime` INT ( 3 ) NULL DEFAULT NULL COMMENT '持续时长',
                               `grade` VARCHAR ( 10 ) CHARACTER
                                   SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '年级',
                               `term` VARCHAR ( 10 ) CHARACTER
                                   SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '学期',
                               `major` VARCHAR ( 20 ) CHARACTER
                                   SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '专业',
                               `institute` VARCHAR ( 20 ) CHARACTER
                                   SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '学院',
                               `totalScore` INT ( 4 ) NULL DEFAULT NULL COMMENT '总分',
                               `type` VARCHAR ( 255 ) CHARACTER
                                   SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '考试类型',
                               `tips` VARCHAR ( 255 ) CHARACTER
                                   SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '考生须知',
                               PRIMARY KEY ( `examCode` ) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20190014 CHARACTER
SET = utf8 COLLATE = utf8_bin COMMENT = '考试管理表' ROW_FORMAT = Dynamic;-- ----------------------------
-- Records of exam_manage
-- ----------------------------
INSERT INTO `exam_manage`
VALUES
    ( 20240001, '2024年上期期末考试', '计算机网络', 1001, '2024-03-21', 120, '2021', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。' );
INSERT INTO `exam_manage`
VALUES
    ( 20190002, '2024年上期期末考试', '数据库理论', 1002, '2024-03-07', 90, '2021', '2', '网络工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。' );
INSERT INTO `exam_manage`
VALUES
    ( 20190003, '2023年下期期末考试', '数据结构', 1003, '2024-02-27', 90, '2021', '1', '软件工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。' );
INSERT INTO `exam_manage`
VALUES
    ( 20190005, '2023年上期期末考试', '计算机导论', 1004, '2024-03-14', 90, '2021', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。' );
INSERT INTO `exam_manage`
VALUES
    ( 20190006, '2022年上期期末考试', '软件工程', 1005, '2024-03-21', 120, '2021', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。' );
INSERT INTO `exam_manage`
VALUES
    ( 20190007, '2023年上期期末考试', '操作系统', 1006, '2024-03-13', 120, '2021', '2', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。' );
INSERT INTO `exam_manage`
VALUES
    ( 20190008, '2023年下期期末考试', 'C语言', 1007, '2024-03-13', 120, '2021', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。' );
INSERT INTO `exam_manage`
VALUES
    ( 20190009, '2023年上期期末考试', '高等数学', 1008, '2024-03-07', 90, '2021', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。' );
INSERT INTO `exam_manage`
VALUES
    ( 20190013, '测试', '测试', 1009, '2024-04-24', 120, '2021', NULL, '测试', '测试', 100, '期末考试', '请不要带与考试无关的书籍。' );-- ----------------------------
-- Table structure for fill_question
-- ----------------------------
DROP TABLE
    IF
    EXISTS `fill_question`;
CREATE TABLE `fill_question` (
                                 `questionId` INT ( 9 ) NOT NULL AUTO_INCREMENT COMMENT '试题编号',
                                 `subject` VARCHAR ( 20 ) CHARACTER
                                     SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '考试科目',
                                 `question` VARCHAR ( 255 ) CHARACTER
                                     SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '试题内容',
                                 `answer` VARCHAR ( 255 ) CHARACTER
                                     SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '正确答案',
                                 `analysis` VARCHAR ( 255 ) CHARACTER
                                     SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '题目解析',
                                 `score` INT ( 2 ) NULL DEFAULT 2 COMMENT '分数',
                                 `level` VARCHAR ( 5 ) CHARACTER
                                     SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '难度等级',
                                 `section` VARCHAR ( 20 ) CHARACTER
                                     SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '所属章节',
                                 PRIMARY KEY ( `questionId` ) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10029 CHARACTER
SET = utf8 COLLATE = utf8_bin COMMENT = '填空题题库' ROW_FORMAT = Dynamic;-- ----------------------------
...
CREATE TABLE `judge_question` (
                                  ...
                                  `analysis` VARCHAR ( 255 ) CHARACTER
                                      SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '题目解析',
                                  `score` INT ( 2 ) NULL DEFAULT 2 COMMENT '分数',
                                  `level` VARCHAR ( 1 ) CHARACTER
                                      SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '难度等级',
                                  `section` VARCHAR ( 20 ) CHARACTER
                                      SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '所属章节',
                                  PRIMARY KEY ( `questionId` ) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10013 CHARACTER
SET = utf8 COLLATE = utf8_bin COMMENT = '判断题题库表' ROW_FORMAT = Dynamic;-- ----------------------------
...
CREATE TABLE `message` (
                           ...
                           `title` VARCHAR ( 20 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '标题',
                           `content` VARCHAR ( 255 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '留言内容',
                           `time` DATE NULL DEFAULT NULL COMMENT '留言时间',
                           PRIMARY KEY ( `id` ) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER
SET = utf8 COLLATE = utf8_bin COMMENT = '留言表' ROW_FORMAT = Dynamic;-- ----------------------------
-- Records of message
-- ----------------------------
VALUES
    ( 15, '咸鱼', '我是一条咸鱼', '2024-03-18' );
INSERT INTO `message`
VALUES
    ( 16, '今天中午吃什么', '今天去吃莲藕排骨汤吧，虽然也不好吃，但这里真的没什么东西可以吃了', '2024-03-18' );
-- ----------------------------
-- Table structure for multi_question
-- ----------------------------
DROP TABLE
    IF
    EXISTS `multi_question`;
CREATE TABLE `multi_question` (
                                  `questionId` INT ( 9 ) NOT NULL AUTO_INCREMENT COMMENT '试题编号',
                                  `subject` VARCHAR ( 20 ) CHARACTER
                                      SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '考试科目',
                                  `question` VARCHAR ( 255 ) CHARACTER
                                      SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '问题题目',
                                  `answerA` VARCHAR ( 255 ) CHARACTER
                                      SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '选项A',
                                  `answerB` VARCHAR ( 255 ) CHARACTER
                                      SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '选项B',
                                  `answerC` VARCHAR ( 255 ) CHARACTER
                                      SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '选项C',
                                  `answerD` VARCHAR ( 255 ) CHARACTER
                                      SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '选项D',
                                  `rightAnswer` VARCHAR ( 10 ) CHARACTER
                                      SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '正确答案',
                                  `analysis` VARCHAR ( 255 ) CHARACTER
                                      SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '题目解析',
                                  `score` INT ( 2 ) NULL DEFAULT 2 COMMENT '分数',
                                  ...
                                  `level` VARCHAR ( 1 ) CHARACTER
                                      SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '难度等级',
                                  PRIMARY KEY ( `questionId` ) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10033 CHARACTER
SET = utf8 COLLATE = utf8_bin COMMENT = '选择题题库表' ROW_FORMAT = Dynamic;-- ----------------------------
...
SET = utf8 COLLATE = utf8_bin COMMENT = '试卷管理表' ROW_FORMAT = Dynamic;-- ----------------------------
...
CREATE TABLE `replay` (
                          ...
                          `replay` VARCHAR ( 255 ) CHARACTER
                              SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '内容',
                          `replayTime` DATE NULL DEFAULT NULL COMMENT '回复时间',
                          PRIMARY KEY ( `replayId` ) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER
SET = utf8 COLLATE = utf8_bin COMMENT = '回复表' ROW_FORMAT = Dynamic;-- ----------------------------
-- Records of replay
-- ----------------------------
INSERT INTO `replay`
VALUES
    ( 34, 19, '1111', '2024-04-16' );
INSERT INTO `replay`
VALUES
    ( 34, 20, '2222', '2024-04-16' );
INSERT INTO `replay`
VALUES
    ( 35, 21, '666', '2024-09-05' );-- ----------------------------
...
CREATE TABLE `score` (
                         ...
                         `subject` VARCHAR ( 20 ) CHARACTER
                             SET utf8 COLLATE utf8_bin NOT NULL COMMENT '课程名称',
                         ...
                         `answerDate` VARCHAR ( 10 ) CHARACTER
                             SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '答题日期',
                         PRIMARY KEY ( `scoreId` ) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER
SET = utf8 COLLATE = utf8_bin COMMENT = '成绩管理表' ROW_FORMAT = Dynamic;-- ----------------------------
-- Records of score
-- ----------------------------
INSERT INTO `score`
VALUES
    ( 4, 20240001, 20240005, '计算机网络', NULL, 70, NULL, '2024-04-03' );
INSERT INTO `score`
VALUES
    ( 14, 20190002, 20240005, '数据库理论', NULL, 78, NULL, '2024-04-20' );
INSERT INTO `score`
VALUES
    ( 15, 20190002, 20240005, '数据库理论', NULL, 80, NULL, '2024-04-20' );
INSERT INTO `score`
VALUES
    ( 16, 20190002, 20240005, '数据库理论', NULL, 83, NULL, '2024-04-20' );
INSERT INTO `score`
VALUES
    ( 17, 20240001, 20240001, '计算机网络', NULL, 74, NULL, '2024-04-13' );
INSERT INTO `score`
VALUES
    ( 18, 20240001, 20240001, '计算机网络', NULL, 70, NULL, '2024-04-10' );
INSERT INTO `score`
VALUES
    ( 19, 20240001, 20240002, '计算机网络', NULL, 86, NULL, '2024-04-14' );
INSERT INTO `score`
VALUES
    ( 20, 20240001, 20240003, '计算机网络', NULL, 90, NULL, '2024-04-11' );
INSERT INTO `score`
VALUES
    ( 21, 20240001, 20240003, '计算机网络', NULL, 92, NULL, '2024-04-12' );
INSERT INTO `score`
VALUES
    ( 22, 20240001, 20240004, '计算机网络', NULL, 80, NULL, '2024-04-12' );
INSERT INTO `score`
VALUES
    ( 23, 20240001, 20240002, '计算机网络', NULL, 90, NULL, '2024-04-13' );
INSERT INTO `score`
VALUES
    ( 24, 20240001, 20240004, '计算机网络', NULL, 88, NULL, '2024-04-14' );
INSERT INTO `score`
VALUES
    ( 27, 20240001, 20240005, '计算机网络', NULL, 80, NULL, '2024-04-25' );
INSERT INTO `score`
VALUES
    ( 30, 20240001, 20240005, '计算机网络', NULL, 0, NULL, '2024-04-29' );
INSERT INTO `score`
VALUES
    ( 31, 20240001, 20240005, '计算机网络', NULL, 0, NULL, '2024-09-06' );-- ----------------------------
...
CREATE TABLE `student` (
                           ...
                           `studentName` VARCHAR ( 20 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '姓名',
                           `grade` VARCHAR ( 4 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '年级',
                           `major` VARCHAR ( 20 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '专业',
                           `clazz` VARCHAR ( 10 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '班级',
                           `institute` VARCHAR ( 30 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '学院',
                           `tel` VARCHAR ( 11 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '电话号码',
                           `email` VARCHAR ( 30 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '电子邮件',
                           `pwd` VARCHAR ( 16 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '密码',
                           `cardId` VARCHAR ( 18 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '身份证号',
                           `sex` VARCHAR ( 2 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '性别',
                           `role` VARCHAR ( 1 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT '2' COMMENT '角色(0管理员，1教师，2学生)',
                           PRIMARY KEY ( `studentId` ) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20215009 CHARACTER
SET = utf8 COLLATE = utf8_bin COMMENT = '学生信息表' ROW_FORMAT = Dynamic;-- ----------------------------
-- Records of student
-- ----------------------------
INSERT INTO `student`
VALUES
    ( 20240001, 'hsj', '2021', '计算机科学与技术', '2', '软件工程学院', '13585439532', 'gblw@163.com', '123456', '3412312', '男', '2' );
INSERT INTO `student`
VALUES
    ( 20240005, 'sj', '2021', '计算机科学与技术', '2', '软件工程学院', '13658377857', '13658377857@sina.cn', '123456', '124123124535', '男', '2' );
INSERT INTO `student`
VALUES
    ( 20240002, 'hjh', '2021', '信息工程', '1', '软件工程学院', '15583829425', '15583829425@163.com', '123456', '3242342', '男', '2' );
INSERT INTO `student`
VALUES
    ( 20240003, 'syj', '2021', '网络工程', '1', '软件工程学院', '18734538457', '18734538457@163.com', '123456', '2423423', '女', '2' );
INSERT INTO `student`
VALUES
    ( 20240004, 'csc', '2021', '信息工程', '2', '软件工程学院', '15523619564', '15523619564@163.com', '123456', '500234199704022353', '男', '2' );-- ----------------------------
...
CREATE TABLE `teacher` (
                           ...
                           `teacherName` VARCHAR ( 20 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '姓名',
                           `institute` VARCHAR ( 20 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '学院',
                           `sex` VARCHAR ( 2 ) CHARACTER
                           ...
                           `tel` VARCHAR ( 11 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '电话号码',
                           `email` VARCHAR ( 20 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '邮箱',
                           `pwd` VARCHAR ( 16 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '密码',
                           `cardId` VARCHAR ( 18 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '身份证号',
                           `type` VARCHAR ( 20 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '职称',
                           `role` VARCHAR ( 1 ) CHARACTER
                               SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '角色（0管理员，1教师，2学生）',
                           PRIMARY KEY ( `teacherId` ) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20081003 CHARACTER
SET = utf8 COLLATE = utf8_bin COMMENT = '教师信息表' ROW_FORMAT = Dynamic;-- ----------------------------
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher`
VALUES
    ( 20081001, '张', '软件工程学院', '男', '13598458442', '13598458442@163.com', '123456', '423423283498', '讲师', '1' );
INSERT INTO `teacher`
VALUES
    ( 20081002, '王大志', '软件工程学院', '男', '1231221312', '1231221312@163.com', '123456', '24241234', '讲师', '1' );
